...
$CommandSource = Resolve-Path (Join-Path $PSScriptRoot ".." | Join-Path -ChildPath "Code\C++\TextFinder\.claude\commands")
...
Write-Host "  2. Run /sdd:init in Claude Code to fill in constitution.md"
Write-Host "  3. Review and edit constitution.md before starting any feature work"
Write-Host "  4. Use /sdd:feature [name] to begin your first feature spec"
Write-Host ""
