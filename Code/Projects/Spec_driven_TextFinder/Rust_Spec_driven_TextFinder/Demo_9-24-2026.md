# Rust_TextFinder — Demonstration Output, 2026-09-24

```

=== starting demonstration: demonstration
=== captured 2026-09-24
   Compiling rust_textfinder_entry v0.1.0 (C:\github\JimFawcett\NewSite\Code\Projects\Spec_driven_TextFinder\Rust_Spec_driven_TextFinder\Rust_Spec_driven_TextFinder_Entry)
...
2. Default expression. The default /r of . with no /n or /L needs no file content,
  ...
  $ rust_textfinder -P . -p "md, ixx, cpp, rs"
      ...
      ... 67 more
      accessed 80 files, 58 directories
