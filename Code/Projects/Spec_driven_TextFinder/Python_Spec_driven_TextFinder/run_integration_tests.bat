@echo off
rem run_integration_tests.bat - compiles the four packages, then drives the assembled program end to end
...
call :suite integration "%HERE%test\integration_tests.py"
