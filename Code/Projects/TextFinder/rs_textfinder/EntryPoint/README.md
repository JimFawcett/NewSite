...
[EntryPoint code](https://github.com/JimFawcett/EntryPoint)
...
EntryPoint is a tool for locating files containing text that matches a specified regular expression. It uses the facilities of RustDirNav and RustCmdLine libraries, and std::fs and regex crates. It can be used to:
...
<img src="https://github.com/JimFawcett/JimFawcett.github.io/blob/master/Pictures/EntryPoint.jpg" style="float:right; margin-left:10px; width:45rem;">
<!-- ![class diagram](https://github.com/JimFawcett/JimFawcett.github.io/blob/master/Pictures/EntryPoint.jpg) -->
