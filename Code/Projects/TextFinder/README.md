...
Search root: `NewSite`, extensions: `py js ts jsx tsx cpp c h hpp ixx cs rs`, content regex: `class`. Statistics over 20 warm-cache runs (first run discarded); median = average of 10th and 11th sorted values.
