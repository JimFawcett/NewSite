...
namespace Project4Starter
{
  ...
  public class Receiver
  {
    ...
    public WebApplication CreateListener()
    {
      var builder = WebApplication.CreateBuilder();
      builder.Services.AddServiceModelServices();
      builder.WebHost.UseUrls("http://" + this.address + ":" + this.port);
      var app = builder.Build();
      app.UseServiceModel(svcBuilder =>
      {
        svcBuilder.AddService<CommService>();
        svcBuilder.AddServiceEndpoint<CommService, ICommService>(
          new BasicHttpBinding(), "/CommService");
      });
      return app;
    }
