...
```html
<view-image src="pictures/StringLayout.JPG" width="400px" bg-color="var(--light)" title-bg-color="#ccc" step-px="100" style="float:right; margin-right:-2rem; margin-top:-1em;">
  Fig 1. String Layout
</view-image>
```
