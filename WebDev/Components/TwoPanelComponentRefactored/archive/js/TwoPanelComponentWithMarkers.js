/* TwoPanelComponent.autoMarkSync.offset.js — classic <script>, no modules
   Features:
     ...
     • Mark/Description sync:
         ...
         - Direction-aware hysteresis: only switch when the next/prev mark ENTERS the offset band
*/
(function () {
  // ---------- helpers ----------
  function parseLen(s) {
